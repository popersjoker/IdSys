...
public class Idcard extends TableI {
/*
 * 
 * */
	protected String id,name,sex,account,pswd,email,owner;
	
	public Idcard(String id, String name, String sex, String account, String pswd,
		String email,String owner) {
	super("Idcard", "(id varchar(30) primary key,name varchar(30),sex varchar(4),account varchar(30),pswd varchar(30) references user(password),email varchar(20),owner varchar(20) references User_(username))");
	String extra="foreign key(account) references user(username)";
	...
	public TableI Maker(ResultSet rs) throws SQLException {
		// TODO Auto-generated method stub
		return new Idcard(rs.getString("id"),rs.getString("name"),rs.getString("sex"),rs.getString("account"),rs.getString("pswd"),rs.getString("email"),rs.getString("owner"));
	}
	...
	public void transfer(Trash id_)
	{
